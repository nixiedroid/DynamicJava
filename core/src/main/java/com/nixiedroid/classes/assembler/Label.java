...
class Label {
    ...
    private final List<Label.PatchInfo> patches = new ArrayList<>();
    ...
    void add(ClassFileAssembler asm,
             ...
             int stackDepth)
    {
        patches.add(new Label.PatchInfo(asm, instrBCI, patchBCI, stackDepth));
    }

    public void bind() {
        for (Label.PatchInfo patch : patches){
