...
public class Methods {
    public static <T> T invokeStaticDirect(Class<?> targetClass, String methodName, Object... arguments) {
        return invokeDirect(targetClass, null, methodName, ArrayList::new, arguments);
    }

    public static <T> T invokeDirect(Object target, String methodName, Object... arguments) {
        return (T) invokeDirect(Classes.retrieveFrom(target), target, methodName, () -> {
    ...
    private static <T> T invokeDirect(Class<?> targetClass, Object target, String methodName, Supplier<List<Object>> listSupplier, Object... arguments) {
        Class<?>[] argsType = Classes.retrieveFrom(arguments);
        Method method = findDirectHandle(targetClass, methodName, argsType);
        try {
            MethodHandle methodHandle = retrieveMethodHandle(Context.i().lookup(), method);
    ...
    private static Method findDirectHandle(Class<?> targetClass, String methodName, Class<?>... inputParameterTypes) {
        Method entry;
        try {
